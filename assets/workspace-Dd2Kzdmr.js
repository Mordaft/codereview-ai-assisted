const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./review-runtime-CEx5vCB6.js","./index-DvYkLLok.js","./dexie-DT85gwXl.js","./rolldown-runtime-CbXtAM7H.js","./index-DVY9QDSM.css","./langgraph-Z193pUsQ.js","./review-prompts-BEeKHNk5.js"])))=>i.map(i=>d[i]);
import{A as e,B as t,C as n,D as r,F as i,I as a,L as o,N as ee,O as s,R as c,U as l,V as u,Y as d,_ as f,a as p,b as te,d as m,g as h,h as g,l as _,m as v,s as ne,t as y,u as b,v as x,w as S,y as re,z as C}from"./index-DvYkLLok.js";import{i as w}from"./platform-api-CjyI-f7D.js";function T(e){if(e==null)return t.PENDING;if(typeof e==`number`&&(e===t.DESIRABLE||e===t.IMPORTANT||e===t.BLOCKING||e===t.PENDING))return e;if(typeof e==`string`)switch(e.toLowerCase().trim()){case`1`:case`deseable`:case`desirable`:return t.DESIRABLE;case`2`:case`importante`:case`important`:return t.IMPORTANT;case`3`:case`bloqueante`:case`blocking`:return t.BLOCKING;default:return t.PENDING}return t.PENDING}async function ie(t){if(!t.id||!t.remoteChange?.webUrl)return;let n=(await s(t.id)).filter(e=>e.decision!==o.PUBLISHED);if(!n.length)return;let r=d(t.remoteChange.webUrl);for(let t of n){let n=t.path?`${t.path}${t.line?`:`+t.line:``}`:v(`workspace.generalComment`),i=`**[${x(t.severity??c.MEDIUM)}]** ${n}\n\n${t.body}`;await w(r,{body:i}),t.id&&await e(t.id)}}async function E(e,o){let{review:d,activeFileIndex:w=0,navigate:D,refreshReviews:O,onFileSelect:k}=o,A=d.status===l.APPROVED||d.status===l.CLOSED||d.status===`Aprobada`||d.status===`Cerrada`,j=p(d),M=d.id?await s(d.id):[],N=d.remoteFiles?.length?d.remoteFiles.map(e=>({path:e.path,type:e.path.split(`.`).at(-1)?.toUpperCase()??`TXT`,lines:(e.content??e.patch??v(`workspace.noFilesDownloadedText`)).split(`
